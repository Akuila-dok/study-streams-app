...
const SignUpPage = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-r from-green-400 via-blue-500 to-purple-500">
      ...
      <div className="relative z-10 bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <p className="text-sm text-gray-600 text-center mb-4">Select your role and sign up</p>
          ...
          {[
            ...
            <button
              ...
              className={`p-3 rounded-lg transition-all duration-200 flex flex-col items-center text-xs font-medium
                ${role === type ? "bg-green-600 text-white shadow-md scale-110" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
        ...
        <form>
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-3 rounded-md text-lg font-medium hover:bg-green-700 transition"
          >
